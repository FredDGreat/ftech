...
import static com.ftech.criptoapp.BtcFragment.LOG_TAG;
...
public class CurrencyQueryUtil {
    ...
    /**
     * Create a private constructor because no one should ever create a {@link CurrencyQueryUtil} object.
     * This class is only meant to hold static variables and methods, which can be accessed
     * directly from the class name QueryUtils (and an object instance of QueryUtils is not needed).
     */
    private CurrencyQueryUtil() {
